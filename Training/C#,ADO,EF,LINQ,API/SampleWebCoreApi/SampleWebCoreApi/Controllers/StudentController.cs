...
using SampleWebCoreApi.services.StudentService;
using System;
using System.Net.NetworkInformation;

namespace SampleWebCoreApi.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Student>>> GetAllStudentDetailes()
        {
            ...
            return _studentService.GetAllStudentDetailes();
        }
        ...
        {
            var student = _studentService.GetStudetailbyID(id);           
            if(student == null)
            {
